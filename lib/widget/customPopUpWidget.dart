    ...
    showDialog(
      ...
      builder: (context) => WillPopScope(
        ...
        child: Dialog(
          ...
          backgroundColor: Color(ListColor.neutral100),
                      ...
                      child: Row(
                        ...
                        children: [
                          SvgPicture.asset(
                            ...
                            colorFilter: ColorFilter.mode(Color(ListColor.neutral10), BlendMode.srcIn),
                          ),
                          Container(
                            ...
                            child: SizedBox(
                              ...
                              child: OutlinedButton(
                                style: OutlinedButton.styleFrom(
                                  ...
                                  backgroundColor: Color(ListColor.infoMain),
                                ),
